...
export function seedClients(): Client[] {
  ...
  return [
    ...
    },
    {
      ...
      projectDescription:
        'Signed 12-month lease begins August 1, 2026 — private room in furnished per-bed home; first month paid early.',
    ...
    },
    {
      ...
      projectDescription:
        'Entire furnished home alone — Active; rent paid on time through July.',
      projectStatus: 'In Progress',
      contractStatus: 'Signed',
      paymentStatus: 'Paid',
      serviceTier: 'Launch',
