...
export function buildResidentialLeaseFields({
  ...
  return {
    ...
    /** Occupancy + property-use summary */
    ...
    /** Monthly rent — blank until landlord sets */
    totalCost: blankField('Enter monthly rent amount'),
    /** Security deposit — blank until landlord sets */
