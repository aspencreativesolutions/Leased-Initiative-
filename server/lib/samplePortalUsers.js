...
function buildMissingSampleClients(now) {
  return [
    ...
    },
    {
      ...
      projectDescription:
        'Signed 12-month lease begins August 1 — private room in furnished per-bed home; first month paid early.',
    ...
    },
    {
      ...
      projectDescription: 'Entire furnished home alone — Active; never late.',
      projectStatus: 'In Progress',
      contractStatus: 'Signed',
      paymentStatus: 'Paid',
      serviceTier: 'Launch',
